    ...
    def get_user_sensor_map
      ...
      Chef::Role.list.each_key do |m_key|
        ...
        begin
          ...
          Chef::Log.error("[get_user_sensor_map] Failed to load role: #{m_key}")
        end

        next unless m && m.override_attributes['redborder'] && m.override_attributes['redborder']['sso_idp_organization_name']
