...
default['redborder']['memory_services']['consul'] = { 'count': 10, 'memory': 0 }
default['redborder']['memory_services']['logstash'] = { 'count': 120, 'memory': 0 }
default['redborder']['memory_services']['minio'] = { 'count': 15, 'memory': 0 }
default['redborder']['memory_services']['nginx'] = { 'count': 15, 'memory': 0 }
default['redborder']['memory_services']['opscode-erchef'] = { 'count': 5, 'memory': 0 }
...
default['redborder']['memory_services']['redborder-ale'] = { 'count': 5, 'memory': 0 }
default['redborder']['memory_services']['redborder-dswatcher'] = { 'count': 5, 'memory': 0 }
default['redborder']['memory_services']['redborder-events-counter'] = { 'count': 5, 'memory': 0 }
default['redborder']['memory_services']['redborder-scanner'] = { 'count': 5, 'memory': 0 }
